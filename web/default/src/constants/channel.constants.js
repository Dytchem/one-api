export const CHANNEL_OPTIONS = [
  ...
  { key: 45, text: 'xAI (Grok)', value: 45, color: 'blue' },
  { key: 46, text: 'Replicate', value: 46, color: 'blue' },
  { key: 52, text: 'Perplexity', value: 52, color: 'teal' },
  { key: 53, text: 'MokaAI', value: 53, color: 'violet' },
  {
    key: 54,
    text: 'Xinference',
    value: 54,
  ...
  { key: 62, text: 'OpenCode Zen', value: 62, color: 'teal' },
  { key: 63, text: 'OpenCode Go', value: 63, color: 'teal' },
  { key: 64, text: 'Ollama Cloud', value: 64, color: 'black' },
  {
    key: 65,
    text: 'NVIDIA NIM',
    value: 65,
